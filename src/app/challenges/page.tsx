    ...
    return (
        <div className="space-y-8 animate-fade-in-up">
            ...
            <Tabs defaultValue="active" className="space-y-4" onValueChange={setActiveTab}>
                <TabsList className="w-full md:w-auto flex md:inline-flex justify-start md:justify-center overflow-x-auto md:overflow-hidden no-scrollbar bg-transparent md:bg-muted p-0 md:p-1 gap-2 md:gap-0">
